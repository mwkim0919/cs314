...
var spotPosition = new THREE.Vector3(70,100,50);
...
var gem_toonMaterial = new THREE.ShaderMaterial({
   uniforms: {
     ...
     spotPosition : {type: 'v3', value: spotPosition},
   },
});
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
  ...
  gem_toonMaterial.vertexShader = shaders['glsl/anis.vs.glsl'];
  gem_toonMaterial.fragmentShader = shaders['glsl/anis.fs.glsl'];
  gem_toonMaterial.needsUpdate = true;
})
 ...
 // tip: change armadillo shading here according to keyboard
  new THREE.SourceLoader().load(shaderFiles, function(shaders) {
    ...
    if (keyboard.pressed("1")) {
      ...
      armadilloMaterial.vertexShader = shaders['glsl/anis.vs.glsl'];
      armadilloMaterial.fragmentShader = shaders['glsl/anis.fs.glsl'];
      armadilloMaterial.needsUpdate = true;
